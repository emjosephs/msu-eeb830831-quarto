...
- Define family-wise error rates and link these to the multiple-testing problem 
- Apply commonly used multiple-testing controls: Bonferroni and FDR
- Identify benefits and problems with the Bonferroni and FDR methods.

## More tests more problems {#sec-multtesting}
