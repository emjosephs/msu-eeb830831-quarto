...
calcSS <- function(x, m){
  m |>
  augment() |>
mutate(sq_resid2 = (x-body_mass_g)^2) |> 
summarise(SS2 = sum(sq_resid2))
}
...
```{r, echo=F}
model3 <- lm(bill_length_mm~1, data=penguins)
plot(1:344, penguins$bill_length_mm, bty="n", col = 'gray', xlab = "penguin number", ylab = "bill length", pch=20)
abline(model3, col=palette()[3], lty=2,lwd=2)
points(186, penguins$bill_length_mm[186], col=palette()[3], pch=17, cex=2)
points(100, penguins$bill_length_mm[100], col=palette()[3], pch=15, cex=2)
points(250, penguins$bill_length_mm[250], col=palette()[3], pch=8, cex=2, lwd=2)
