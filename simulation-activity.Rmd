...
df1 <- data.frame(crosstype = c(rep('outbred',130),rep('selfed',150)), daystf = c(outbred,selfed))
...
```{r}
df1$fruitno <- df1$daystf*mybeta + rnorm(n=280, mean=0, sd=5) + 35

ggplot(df1)+aes(x=daystf,y=fruitno, colour=crosstype)+
