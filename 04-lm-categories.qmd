...
There may be times where we have multiple category values but instead of knowing the effect of each category value on the outcome, we want to know how much variation the categories explain in general.
