...
In this section we'll expand our linear model to test for differences between categories.
...
We could rewrite the above equation as
$$ Mass_{i|\text{Adelie}} = b_0 + e_i$$
$$ Mass_{i|\text{Gentoo}} = b_0 + b_1 + e_i$$
