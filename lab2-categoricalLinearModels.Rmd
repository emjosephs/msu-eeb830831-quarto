...
Some tasks to get us started: 1. Go to the header above and edit the date and author to reflect who you are and when you are working on this. 2. Look at the packages included in the chunk above. Run the code in that chunk and install any packages that aren't yet installed. You also will want to make sure that the "rmarkdown" package is installed.
