...
This is a lab to practice simple linear models with means and categories. You'll also get to practice working with an R markdown file. 

Some tasks to get us started:
1. Go to the header above and edit the date and author to reflect who you are and when you are working on this.
2. Look at the packages included in the chunk above. Run the code in that chunk and install any packages that aren't yet installed. You also will want to make sure that the "rmarkdown" package is installed.

Now we can get going with the lab.
...
**Q1: Make a linear model with lm() to assess whether flower category affects number of visits.  How do you interpret the output of the linear model? What do the results tell you about pollinator behavior?**
...
**Q2.1 Optional Challenge Question. Edit the code below to conduct the ANOVA by hand. I've included some phrases in []s that you will need to replace with variable names or numbers**
