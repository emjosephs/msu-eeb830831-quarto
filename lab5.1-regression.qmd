...
Go back to your original model of population size and diversity. Use the sample() function to sample 1/2 of your data points and rerun the model. 

```{r, eval=F, echo=F}
myData2 <-myData1[sample(1:300,150),]
model2 <- lm(diversity~log10_popsize,data=myData2)
