---
title: "Chapter 3 -- Linear Models 1: The Mean"
format: html
editor: source
---
...
In practice, fitting a linear model requires picking explanatory variables and then estimating the values of $a$, $b_1$, $b_2$, and so on. These estimates then tell us how the explanatory variables relate to the response variable.
